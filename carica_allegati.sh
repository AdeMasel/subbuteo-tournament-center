...
FILE=(
  "Manuale-Subbuteo-Tournament-Center-6.0.pdf"
  "Subbuteo-Tournament-Center-6.0.0-macOS-AppleSilicon.dmg"
  "Subbuteo-Tournament-Center-6.0.0-macOS-Intel.dmg"
  "Subbuteo-Tournament-Center-Setup-6.0.0-Windows.exe"
  "Subbuteo-Tournament-Center-6.0.0-Linux-x86_64.AppImage"
  "Subbuteo-Tournament-Center-6.0.0-Linux-arm64.AppImage"
)
